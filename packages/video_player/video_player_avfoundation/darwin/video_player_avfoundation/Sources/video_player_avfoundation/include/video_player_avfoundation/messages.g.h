...
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)durationForPlayer:(NSInteger)playerId error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)startForPlayer:(NSInteger)playerId error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)setBufferSec:(NSInteger)second forPlayer:(NSInteger)playerId error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)playingForPlayer:(NSInteger)playerId error:(FlutterError *_Nullable *_Nonnull)error;
@end
