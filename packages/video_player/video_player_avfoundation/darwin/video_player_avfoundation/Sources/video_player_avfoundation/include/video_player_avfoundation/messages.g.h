...
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)duration:(NSInteger)textureId error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)start:(NSInteger)textureId error:(FlutterError *_Nullable *_Nonnull)error;
